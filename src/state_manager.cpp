...
void state_manager_init(StateManager *state_manager){
  ...
  state_manager->stack = (State**)malloc(state_manager->capacity * sizeof(State*));
  state_manager->top = -1;
}
...
int state_manager_scale(StateManager *state_manager){
  ...
  state_manager->stack = (State**)realloc(state_manager->stack, state_manager->capacity * sizeof(State*));
